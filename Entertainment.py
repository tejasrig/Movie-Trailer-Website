...
ratatoullie = media.Movie(
    "Ratatoullie",
    "A story of a Rat and his love for cooking",
    "https://54disneyreviews.files.wordpress.com/2015/07/ratatouille1.jpg",
...
forestgump = media.Movie(
    "Forrest Gump",
    "The World will never be the same once you see it throught the eyes of Forrest Gump",  # noqa
    "https://upload.wikimedia.org/wikipedia/sco/6/67/Forrest_Gump_poster.jpg",
...
davincicode = media.Movie(
    "The da vinci code",
    "Seek the Truth",
    "https://upload.wikimedia.org/wikipedia/en/e/e9/The_da_vinci_code_final.jpg",  # noqa
